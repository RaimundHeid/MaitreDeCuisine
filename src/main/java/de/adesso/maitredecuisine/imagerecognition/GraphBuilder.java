...
/**
 * Hilfsklasse zum vorbehandeln der Bilder. Aus dem Internet geklaut
 */
public class GraphBuilder {
    ...
    <T, U> Output<U> cast2(Output<T> value, Class<U> type) {
        DataType dtype = DataType.fromClass(type);
        return g.opBuilder("Cast", "Cast2").addInput(value).setAttr("DstT", dtype).build().<U>output(0);
    }
